...
public class MainCourseActivity extends AppCompatActivity {
    ...
    private void initViews() {
        recyclerView = findViewById(R.id.recyclerViewMainCourse);
    ...
    private void setupFloatingCartIcon() {
        floatingCartIcon.setOnClickListener(v -> {
            Intent intent = new Intent(MainCourseActivity.this, ShoppingCartActivity.class);
    ...
    private void loadMenuItems() {
        ...
        menuItemsListener = db.collection("menuItems")
                .whereEqualTo("category", "Main Course")
                .addSnapshotListener((queryDocumentSnapshots, error) -> {
                    if (error != null) {
                        Log.e("MainCourseActivity", "Listen failed: " + error.getMessage(), error);
                        Toast.makeText(this, "Error loading main course dishes: " + error.getMessage(),
                    ...
                    if (queryDocumentSnapshots != null) {
                        ...
                        for (QueryDocumentSnapshot document : queryDocumentSnapshots) {
                            ...
                            Log.d("MainCourseActivity", "Loaded item: " + menuItem.getDishName() +
                        ...
                        if (menuItemList.isEmpty()) {
                            Toast.makeText(this, "No main course dishes found", Toast.LENGTH_SHORT).show();
                        } else {
                            Log.d("MainCourseActivity", "Loaded " + menuItemList.size() + " main course items");
                        }
                    }
                });
    }
