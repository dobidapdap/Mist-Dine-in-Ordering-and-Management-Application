...
public class PlatterActivity extends AppCompatActivity {
    ...
    private void initViews() {
        recyclerView = findViewById(R.id.recyclerViewPlatter);
    ...
    private void setupFloatingCartIcon() {
        floatingCartIcon.setOnClickListener(v -> {
            Intent intent = new Intent(PlatterActivity.this, ShoppingCartActivity.class);
    ...
    private void loadMenuItems() {
        ...
        menuItemsListener = db.collection("menuItems")
                .whereEqualTo("category", "Platter")
                .addSnapshotListener((queryDocumentSnapshots, error) -> {
                    if (error != null) {
                        Log.e("PlatterActivity", "Listen failed: " + error.getMessage(), error);
                        Toast.makeText(this, "Error loading platter dishes: " + error.getMessage(),
                    ...
                    if (queryDocumentSnapshots != null) {
                        ...
                        for (QueryDocumentSnapshot document : queryDocumentSnapshots) {
                            ...
                            Log.d("PlatterActivity", "Loaded item: " + menuItem.getDishName() +
                        ...
                        if (menuItemList.isEmpty()) {
                            Toast.makeText(this, "No platter dishes found", Toast.LENGTH_SHORT).show();
                        } else {
                            Log.d("PlatterActivity", "Loaded " + menuItemList.size() + " platter items");
                        }
                    }
                });
    }
