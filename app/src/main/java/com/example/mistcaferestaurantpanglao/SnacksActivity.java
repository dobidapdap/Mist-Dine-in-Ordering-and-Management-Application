...
public class SnacksActivity extends AppCompatActivity {
    ...
    private void setupFloatingCartIcon() {
        floatingCartIcon.setOnClickListener(v -> {
            Intent intent = new Intent(SnacksActivity.this, ShoppingCartActivity.class);
    ...
    private void loadMenuItems() {
        ...
        menuItemsListener = db.collection("menuItems")
                ...
                .addSnapshotListener((queryDocumentSnapshots, error) -> {
                    if (error != null) {
                        Log.e("SnacksActivity", "Listen failed: " + error.getMessage(), error);
                        Toast.makeText(this, "Error loading snacks: " + error.getMessage(),
                    ...
                    if (queryDocumentSnapshots != null) {
                        ...
                        for (QueryDocumentSnapshot document : queryDocumentSnapshots) {
                            ...
                            Log.d("SnacksActivity", "Loaded item: " + menuItem.getDishName() +
                        ...
                        if (menuItemList.isEmpty()) {
                            Toast.makeText(this, "No snacks found", Toast.LENGTH_SHORT).show();
                        } else {
                            Log.d("SnacksActivity", "Loaded " + menuItemList.size() + " snack items");
                        }
                    }
                });
    }
