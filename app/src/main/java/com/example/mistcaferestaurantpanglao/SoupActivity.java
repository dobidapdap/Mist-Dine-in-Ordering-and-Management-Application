...
public class SoupActivity extends AppCompatActivity {
    ...
    private void initViews() {
        recyclerView = findViewById(R.id.recyclerViewSoup);
    ...
    private void setupFloatingCartIcon() {
        floatingCartIcon.setOnClickListener(v -> {
            Intent intent = new Intent(SoupActivity.this, ShoppingCartActivity.class);
    ...
    private void loadMenuItems() {
        ...
        menuItemsListener = db.collection("menuItems")
                .whereEqualTo("category", "Soup")
                .addSnapshotListener((queryDocumentSnapshots, error) -> {
                    if (error != null) {
                        Log.e("SoupActivity", "Listen failed: " + error.getMessage(), error);
                        Toast.makeText(this, "Error loading soup dishes: " + error.getMessage(),
                    ...
                    if (queryDocumentSnapshots != null) {
                        ...
                        for (QueryDocumentSnapshot document : queryDocumentSnapshots) {
                            ...
                            Log.d("SoupActivity", "Loaded item: " + menuItem.getDishName() +
                        ...
                        if (menuItemList.isEmpty()) {
                            Toast.makeText(this, "No soup dishes found", Toast.LENGTH_SHORT).show();
                        } else {
                            Log.d("SoupActivity", "Loaded " + menuItemList.size() + " soup items");
                        }
                    }
                });
    }
