...
public class DrinksActivity extends AppCompatActivity {
    ...
    private void setupFloatingCartIcon() {
        floatingCartIcon.setOnClickListener(v -> {
            Intent intent = new Intent(DrinksActivity.this, ShoppingCartActivity.class);
    ...
    private void loadMenuItems() {
        ...
        menuItemsListener = db.collection("menuItems")
                ...
                .addSnapshotListener((queryDocumentSnapshots, error) -> {
                    if (error != null) {
                        Log.e("DrinksActivity", "Listen failed: " + error.getMessage(), error);
                        Toast.makeText(this, "Error loading drinks: " + error.getMessage(),
                    ...
                    if (queryDocumentSnapshots != null) {
                        ...
                        for (QueryDocumentSnapshot document : queryDocumentSnapshots) {
                            ...
                            Log.d("DrinksActivity", "Loaded item: " + menuItem.getDishName() +
                        ...
                        if (menuItemList.isEmpty()) {
                            ...
                            Log.d("DrinksActivity", "Loaded " + menuItemList.size() + " drink items");
                        }
                    }
                });
    }
